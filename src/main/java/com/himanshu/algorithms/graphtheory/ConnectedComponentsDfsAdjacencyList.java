...
public class ConnectedComponentsDfsAdjacencyList {
    private final int n;
    ...
    public ConnectedComponentsDfsAdjacencyList(List<List<Integer>> graph) {
    ...
    public static void main(String[] args) {
        ...
        ConnectedComponentsDfsAdjacencyList solver;
        solver = new ConnectedComponentsDfsAdjacencyList(graph);
