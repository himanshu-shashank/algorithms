 ...
 *
 */
package com.himanshu.algorithms.graphtheory;
...
public class DijkstrasShortestPathAdjacencyList {
    ...
    public static void main(String[] args) {
        DijkstrasShortestPathAdjacencyList dijkstrasShortestPathAdjacencyList = new DijkstrasShortestPathAdjacencyList(6);
        graph.get(0).add(new Edge(0, 1, 3));
        graph.get(0).add(new Edge(0, 2, 2));
        graph.get(0).add(new Edge(1, 3, 1));
        ...
        System.out.println(dijkstrasShortestPathAdjacencyList.dijkstra(0,4));
        System.out.println(dijkstrasShortestPathAdjacencyList.reconstructPath(0,4));
    }
}
