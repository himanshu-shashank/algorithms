...
public class KruskalsMSTUnionFind {
    ...
    public KruskalsMSTUnionFind(List<Edge> edges, int n) {
    ...
    public static void main(String[] args) {
        ...
        KruskalsMSTUnionFind solver;
        solver = new KruskalsMSTUnionFind(edges, numNodes);
